...
use CdiUser\Options\UserEditOptionsInterface;
use Zend\Form\Form;
...
class EditUser extends Register {
    ...
    public function __construct($name = null, UserEditOptionsInterface $options, RegistrationOptionsInterface $registerOptions, $serviceManager) {
        ...
        $om = $this->getServiceManager('doctrine.entitymanager.orm_default');

        $this->setHydrator(new \DoctrineORMModule\Stdlib\Hydrator\DoctrineEntity($om, 'CdiUser\Entity\User'))
